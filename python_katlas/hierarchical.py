...
# %% auto #0
__all__ = ['get_Z_custom', 'get_Z_cache', 'auto_thr', 'plot_dendrogram', 'get_color_groups', 'get_cluster', 'pssm_to_seq',
           'get_pssm_seq_labels']
...
# %% ../nbs/04b_hierarchical.ipynb #0c5fece6
...
# %% ../nbs/04b_hierarchical.ipynb #2198d769
_Z_CACHE = LRUCache(maxsize=50)

# %% ../nbs/04b_hierarchical.ipynb #61c817f6
def get_Z_cache(df):
...
# %% ../nbs/04b_hierarchical.ipynb #24ef3f00
...
# %% ../nbs/04b_hierarchical.ipynb #2b1ed0b6
...
# %% ../nbs/04b_hierarchical.ipynb #da62651a
...
# %% ../nbs/04b_hierarchical.ipynb #1dbc5185
def get_cluster(df,pct=95,thr=None,plot=False,labels=None,**kwargs):
    "Get flat cluster assignments from hierarchical clustering linkage matrix `Z`."
    Z = get_Z_cache(df)
    thr = auto_thr(Z,percentile=pct) if thr is None else thr
...
# %% ../nbs/04b_hierarchical.ipynb #34416acb
...
# %% ../nbs/04b_hierarchical.ipynb #40eb15f3
