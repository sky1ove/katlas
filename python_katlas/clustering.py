# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_clustering.ipynb.
...
# %% ../nbs/04_clustering.ipynb #f79922a2-ec05-477a-88b4-39422b9da998
...
# %% ../nbs/04_clustering.ipynb #dd0a21aa-5a87-46b1-9a06-0b9ca65959af
def get_1d_js(df): 
    "Compute 1D distance using JS divergence."
    return get_1d_distance(df,js_divergence_flat)

# %% ../nbs/04_clustering.ipynb #33a0b685-79a8-4aa3-83e4-6bdc687343d4
def get_distance(pair, df, func):
    i, j = pair
    return func(df.iloc[i], df.iloc[j])

# %% ../nbs/04_clustering.ipynb #1b6e4e42-c27c-48b0-ac6b-fff654bc8eba
...
# %% ../nbs/04_clustering.ipynb #ead901d7-d928-4d38-8f7f-c43ab2afde3d
...
# %% ../nbs/04_clustering.ipynb #51fa5e1a-e354-4ca2-90eb-98a876cc7b7f
...
# %% ../nbs/04_clustering.ipynb #e4d4b7ab-4418-4400-ae51-a862e58e3e83
...
# %% ../nbs/04_clustering.ipynb #e0e7beca-7a0d-4565-9e60-f4a37fbcfb60
...
# %% ../nbs/04_clustering.ipynb #15763f5a-ea79-41ec-abd8-baf051101c7a
