...
# %% ../nbs/05_feature.ipynb #773551a9
def_device = 'mps' if torch.backends.mps.is_available() else 'cuda' if torch.cuda.is_available() else 'cpu'

# %% ../nbs/05_feature.ipynb #d7e955b8
