...
# %% ../../nbs/02b_pssm_plot.ipynb #22fca0c1-2eae-490c-8261-e00c12ddc0b8
...
# %% ../../nbs/02b_pssm_plot.ipynb #2a1458d7-5198-44f0-85a4-0ee26ff125ac
def pSTY2sty(string):
    "Convert pS/pT/pY to s/t/y in a string."
    return string.replace('pS', 's').replace('pT', 't').replace('pY', 'y')

# %% ../../nbs/02b_pssm_plot.ipynb #3bec4a75-7234-47b8-965a-666fa0fcdddd
def sty2pSTY(string):
    "Convert s/t/y to pS/pT/pY in a string."
    return string.replace('s', 'pS').replace('t', 'pT').replace('y', 'pY')

# %% ../../nbs/02b_pssm_plot.ipynb #872c976c-a68d-4ba4-b4c2-c60f7c1b7e5d
def sty2pSTY_df(df):
...
# %% ../../nbs/02b_pssm_plot.ipynb #f41d74f8-edbb-4e6d-8825-563e96629f86
@delegates(sns.heatmap)
...
# %% ../../nbs/02b_pssm_plot.ipynb #35812037-2ee8-48dc-9cdc-91cad0197f65
...
# %% ../../nbs/02b_pssm_plot.ipynb #66de6732-d828-4f72-aaf9-64bafbbdba83
...
# %% ../../nbs/02b_pssm_plot.ipynb #7bfd5b54-aec2-4a31-b5c6-d8a6f40c74d9
...
# %% ../../nbs/02b_pssm_plot.ipynb #1f5495fe-c1d3-4d9b-ac7e-4a2dba42f727
...
# %% ../../nbs/02b_pssm_plot.ipynb #33f5cde1-4de1-458e-bdef-6209f7ba04d6
...
# %% ../../nbs/02b_pssm_plot.ipynb #6e9467e4-428c-4ad6-bdde-cc3f4c76cabf
...
# %% ../../nbs/02b_pssm_plot.ipynb #a80895ac-4719-43e7-abd9-b55bc9f96244
...
# %% ../../nbs/02b_pssm_plot.ipynb #8bd8fb94-6fc3-4fe1-8e5e-09717c1bd4f2
...
# %% ../../nbs/02b_pssm_plot.ipynb #0cbb5b93-adcd-4d85-b256-14962e8cdeb3
...
# %% ../../nbs/02b_pssm_plot.ipynb #74d5d77e-2ab0-4407-b5e7-ee7c8f7a91a9
...
# %% ../../nbs/02b_pssm_plot.ipynb #ed877af3-e167-4a81-8e37-46ca113380bb
...
# %% ../../nbs/02b_pssm_plot.ipynb #72b60f5f-df12-43bc-b6e1-da0e0b37c211
