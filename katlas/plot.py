...
# %% auto 0
__all__ = ['logo_func', 'get_logo', 'get_logo2', 'plot_rank', 'plot_hist', 'get_heatmap', 'plot_heatmap', 'plot_2d',
           'plot_cluster', 'assign_colors', 'get_color_dict', 'plot_bokeh', 'plot_bokeh_category', 'plot_count',
           'plot_bar', 'plot_corr', 'draw_corr']
