...
# %% auto 0
__all__ = ['set_sns', 'get_color_dict', 'plot_rank', 'plot_hist', 'plot_2d', 'plot_cluster', 'plot_bokeh', 'plot_count',
           'plot_bar', 'plot_group_bar', 'plot_box', 'plot_corr', 'get_similarity', 'plot_matrix', 'get_AUCDF',
