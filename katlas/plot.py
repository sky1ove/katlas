...
# %% auto 0
__all__ = ['sty_color', 'group_color', 'pspa_category_color', 'set_sns', 'save_show', 'get_color_dict', 'get_plt_color',
           'get_hue_big', 'reduce_feature', 'plot_2d', 'plot_cluster', 'plot_bokeh', 'plot_rank', 'plot_hist',
           'plot_count', 'plot_bar', 'plot_group_bar', 'plot_stacked', 'plot_box', 'plot_corr', 'get_similarity',
           'plot_matrix', 'get_AUCDF', 'plot_confusion_matrix', 'plot_pie', 'get_pct', 'plot_composition', 'plot_cnt']
