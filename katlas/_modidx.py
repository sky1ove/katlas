...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'katlas.align': { 'katlas.align.aln2df': ('alignment.html#aln2df', 'katlas/align.py'),
            ...
            'katlas.clustering': { 'katlas.clustering.get_1d_distance': ('hierarchical.html#get_1d_distance', 'katlas/clustering.py'),
                                   ...
                                   'katlas.clustering.kl_divergence': ('hierarchical.html#kl_divergence', 'katlas/clustering.py'),
                                   'katlas.clustering.kl_divergence_flat': ('hierarchical.html#kl_divergence_flat', 'katlas/clustering.py'),
            ...
            'katlas.dl': { 'katlas.dl.CE': ('dnn.html#ce', 'katlas/dl.py'),
                           'katlas.dl.CNN1D_1': ('dnn.html#cnn1d_1', 'katlas/dl.py'),
                           'katlas.dl.CNN1D_1.__init__': ('dnn.html#cnn1d_1.__init__', 'katlas/dl.py'),
                           'katlas.dl.CNN1D_1.forward': ('dnn.html#cnn1d_1.forward', 'katlas/dl.py'),
                           'katlas.dl.CNN1D_2': ('dnn.html#cnn1d_2', 'katlas/dl.py'),
                           'katlas.dl.CNN1D_2.__init__': ('dnn.html#cnn1d_2.__init__', 'katlas/dl.py'),
                           'katlas.dl.CNN1D_2.forward': ('dnn.html#cnn1d_2.forward', 'katlas/dl.py'),
                           'katlas.dl.GeneralDataset': ('dnn.html#generaldataset', 'katlas/dl.py'),
                           'katlas.dl.GeneralDataset.__getitem__': ('dnn.html#generaldataset.__getitem__', 'katlas/dl.py'),
                           'katlas.dl.GeneralDataset.__init__': ('dnn.html#generaldataset.__init__', 'katlas/dl.py'),
                           'katlas.dl.GeneralDataset.__len__': ('dnn.html#generaldataset.__len__', 'katlas/dl.py'),
                           'katlas.dl.MLP_1': ('dnn.html#mlp_1', 'katlas/dl.py'),
                           'katlas.dl.PSSM_model': ('dnn.html#pssm_model', 'katlas/dl.py'),
                           'katlas.dl.PSSM_model.__init__': ('dnn.html#pssm_model.__init__', 'katlas/dl.py'),
                           'katlas.dl.PSSM_model.forward': ('dnn.html#pssm_model.forward', 'katlas/dl.py'),
                           'katlas.dl.conv_wn': ('dnn.html#conv_wn', 'katlas/dl.py'),
                           'katlas.dl.init_weights': ('dnn.html#init_weights', 'katlas/dl.py'),
                           'katlas.dl.lin_wn': ('dnn.html#lin_wn', 'katlas/dl.py'),
                           'katlas.dl.predict_dl': ('dnn.html#predict_dl', 'katlas/dl.py'),
                           'katlas.dl.seed_everything': ('dnn.html#seed_everything', 'katlas/dl.py'),
                           'katlas.dl.train_dl': ('dnn.html#train_dl', 'katlas/dl.py'),
                           'katlas.dl.train_dl_cv': ('dnn.html#train_dl_cv', 'katlas/dl.py')},
            ...
            'katlas.pssm': { 'katlas.pssm._clean_zero': ('pssm.html#_clean_zero', 'katlas/pssm.py'),
                             ...
                             'katlas.pssm.change_center_name_series': ('pssm.html#change_center_name_series', 'katlas/pssm.py'),
                             ...
                             'katlas.pssm.preprocess_pssm_pspa': ('pssm.html#preprocess_pssm_pspa', 'katlas/pssm.py'),
                             'katlas.pssm.raw2norm': ('pssm.html#raw2norm', 'katlas/pssm.py'),
                             'katlas.pssm.recover_pssm': ('pssm.html#recover_pssm', 'katlas/pssm.py'),
                             'katlas.pssm.recover_pssm_pspa': ('pssm.html#recover_pssm_pspa', 'katlas/pssm.py'),
            ...
            'katlas.score': { 'katlas.score.Params': ('scoring.html#params', 'katlas/score.py'),
                              ...
                              'katlas.score.multiply_func': ('scoring.html#multiply_func', 'katlas/score.py'),
