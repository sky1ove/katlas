...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'katlas.analyze': { 'katlas.analyze.get_metaP': ('analyze.html#get_metap', 'katlas/analyze.py'),
            ...
            'katlas.preprocess': { 'katlas.preprocess.check_seq': ('preprocess.html#check_seq', 'katlas/preprocess.py'),
                                   'katlas.preprocess.check_seq_df': ('preprocess.html#check_seq_df', 'katlas/preprocess.py'),
                                   'katlas.preprocess.extract_site_seq': ('preprocess.html#extract_site_seq', 'katlas/preprocess.py'),
                                   'katlas.preprocess.phosphorylate_seq': ('preprocess.html#phosphorylate_seq', 'katlas/preprocess.py'),
                                   'katlas.preprocess.phosphorylate_seq_df': ( 'preprocess.html#phosphorylate_seq_df',
                                                                               'katlas/preprocess.py'),
                                   'katlas.preprocess.validate_site': ('preprocess.html#validate_site', 'katlas/preprocess.py'),
                                   'katlas.preprocess.validate_site_df': ('preprocess.html#validate_site_df', 'katlas/preprocess.py')},
            'katlas.pssm': { 'katlas.pssm.entropy': ('pssm.html#entropy', 'katlas/pssm.py'),
                             ...
                             'katlas.pssm.get_IC_standard': ('pssm.html#get_ic_standard', 'katlas/pssm.py'),
                             ...
                             'katlas.pssm.process_pssm': ('pssm.html#process_pssm', 'katlas/pssm.py'),
                             'katlas.pssm.pssm2dict': ('pssm.html#pssm2dict', 'katlas/pssm.py'),
