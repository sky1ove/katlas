...
# %% auto 0
__all__ = ['EPSILON', 'kl_divergence', 'kld_mean_flat', 'js_divergence', 'jsd_mean_flat', 'get_1d_distance', 'get_1d_js',
           'get_distance', 'get_1d_distance_parallel', 'get_1d_js_parallel', 'get_Z', 'plot_dendrogram', 'pssm_to_seq',
           'get_pssm_seq_labels']
...
def kld_mean_flat(p1_flat, # pd.Series of target flattened pssm p
...
def jsd_mean_flat(p1_flat, # pd.Series of flattened pssm
...
def get_1d_js(df): 
    ...
    return get_1d_distance(df,jsd_mean_flat)
...
def get_1d_js_parallel(df, func_flat=jsd_mean_flat, **kwargs): 
...
def get_Z(pssms,func_flat=jsd_mean_flat,parallel=True):
