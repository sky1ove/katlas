...
# %% auto 0
__all__ = ['cut_seq', 'STY2sty', 'get_dict', 'multiply_func', 'multiply', 'get_pos_range', 'cut_seq_on_pssms',
           'cut_seq_on_pssms_df', 'calculate_log_odds', 'get_kinase_log_odds', 'check_seqs', 'get_kinase_log_odds_df',
           'sumup', 'predict_kinase', 'Params', 'predict_kinase_df', 'get_pct', 'get_pct_df']
